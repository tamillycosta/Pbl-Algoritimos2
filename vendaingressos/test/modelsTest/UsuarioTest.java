...
public class UsuarioTest {
    ...
    public void testCadastrarUsuario() {
        UsuarioComum usuario = new UsuarioComum("johndoe", "senha123",  "12345678901", "john.doe@example.com");
    ...
    public void testEmailInvalido() {
        new UsuarioComum("johndoe", "senha123",  "12345678901", "john.doe"); // Deve lançar exceção
    }


    @Test(expected = IllegalArgumentException.class)
    public  void testVerificarSenha(){
        UsuarioComum usuarioInvalidoSenha = new UsuarioComum("johndoe", "123", "12345678901", "john.doe@example.com");
    ...
    public  void testeUsuarioDuplicado(){
        ...
        UsuarioComum usuario = new UsuarioComum("johndoe", "senha123",  "12345678901", "john.doe@example.com");
        UsuarioComum usuarioDuplicado = new UsuarioComum("johndoe", "senha456",  "98765432109", "jane.doe@example.com");
